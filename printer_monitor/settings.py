"""
Django settings for printer_monitor project.
...
WSGI_APPLICATION = 'printer_monitor.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {'charset': 'utf8mb4', 'init_command' : 'SET default_storage_engine=MyISAM',},
        'NAME': 'printer_monitor',                      # Or path to database file if using sqlite3.
